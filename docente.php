...
<html lang="en">
  ...
  <head>
    ...
    <!-- Sweet - Alert-->
    <script src="vendor/sweet-alert/dist/sweetalert2.all.js"></script>
    <script src="vendor/sweet-alert/dist/sweetalert2.all.min.js"></script>
    <script src="vendor/sweet-alert/dist/sweetalert2.min.js"></script>
    <script src="vendor/sweet-alert/dist/sweetalert2.min.js"></script>
    <!-- Sweet Alert Styles -->
    <link href="vendor/sweet-alert/dist/sweetalert2.csss" rel="stylesheet">
    <link href="vendor/sweet-alert/dist/sweetalert2.min.csss" rel="stylesheet">
  </head>
              ...
              if(isset($_GET["n"]))
              {
                  switch($_GET["n"])
                  {
                      case '1':
                          ?>
                          <script type="text/javascript">
                            Swal('Ocurrio un Error.!!','No se puede actualizar','error')                       
                            then((value) => {
                              window.location.href="docente.php";
                            });                            
                            </script>
                      ...
                      case '2':
                          ?>
                          <script type="text/javascript">
                            Swal('Actualizacion existoso!','El registro ha sido actualizado exitosamente','success')                            
                            then((value) => {
                              window.location.href="docente.php";
                            });
                          </script>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                      <label >Nombre:</label>
                      <input class="form-control " type="text" value="<?php echo $datos[0]["texto"];?>" name="name">                
                    </div>
                    <div class="form-group">
                      <label >Apellido:</label>
                      <input class="form-control " type="text" values="<?php echo $datos[1]["texto"];?>" name="lastname">                
                    </div>
                    <div class="form-group">
                      <label >Identificador:</label>
                      <input class="form-control " type="text" value="<?php echo $datos[2]["texto"];?>" name="ident">
                    </div>
                    <div class="form-group">
                      <label >Descripcion:</label>
                      <input class="form-control " type="text" value="<?php echo $datos[0]["texto"];?>" name="description">                
                    </div>
                  </div>           
                <div class="modal-footer ">
