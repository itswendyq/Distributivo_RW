...
$datos=$tra->get_dato_por_id($_GET["id_maestro"]);
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
         <!-- Breadcrumbs-->
                  ...
                  <table id="mytable" class="table table-bordred table-striped">
                    <thead>                      
                      ...
                      <tbody>
                        ...
                        <td><a href="docente_edit.php#?id=<?php echo $datos[$i]["id_maestro"]; ?>"><p data-placement="top" data-toggle="tooltip"  title="Edit"><button class="btn btn-success btn-round btn-just-icon btn-sm" data-title="Edit" data-toggle="modal" data-target="#edit"><i class="material-icons">edit</i></button></p></a></td>
            ...
            <?php
                if(isset($_GET["m"]))
                {
                    switch($_GET["m"])
                    {
                        ...
                        case '2':
                            ?>
                            <h4 style="color: green;">La noticia ha sido editada exitosamente</h4>
                            <?php
                        break;
                    }
                }
          ...
          <form role="form" action="docente_edit.php#?id=<?php echo $datos[$i]["id_maestro"]; ?>" method="post">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                      ...
                      <input class="form-control " value="<?php echo $datos[2]["titulo"];?>" type="text">
                    </div>
                    <div class="form-group">
                      <label >Nombre</label>              
